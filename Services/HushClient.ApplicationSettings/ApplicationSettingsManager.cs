...
public class ApplicationSettingsManager : IApplicationSettingsManager, IBootstrapper
{
    ...
    public Task LoadSettingsAsync()
    {
        ...
        var applicationSettingsFilePath = Path.Combine(executingAssemblyFolder, "ApplicationSettings.json");
        ...
        this.UserProfile = config
            .GetRequiredSection("UserProfile")
            .Get<UserProfile>();
